...
def save_dataset(df: pd.DataFrame, dataset_type: str, balance: int = None, is_target: bool = None, technique: str = None, encoding: str = None) -> None:
    df.to_csv((
        f'../data/'
        ...
        f'{f"_{encoding}" if encoding else ""}'
        f'.csv'
    ))
